...
import comparison.EqualNode;
import comparison.GreaterEqualNode;
import comparison.GreaterNode;
import comparison.LessEqualNode;
import comparison.LesserNode;
import comparison.NotEqualNode;
import lib.FOOLlib;
import models.type.BoolTypeNode;
import models.type.IntTypeNode;
import node.BoolNode;
import node.IdNode;
import node.IntNode;
import operation_bool.AndBooleanOperationNode;
import operation_bool.OrBooleanOperationNode;
import operation_int.DivNode;
import operation_int.MinusNode;
import operation_int.MultNode;
import operation_int.PlusNode;
import parameter.ParNode;
import parser.*;
import parser.FOOLParser.*;
import statement.AssignmentNode;
import statement.BlockNode;
import statement.CallNode;
import statement.DeletionNode;
import statement.FunNode;
import statement.IfNode;
import statement.InitBlockNode;
import statement.PrintNode;
import statement.VarNode;
