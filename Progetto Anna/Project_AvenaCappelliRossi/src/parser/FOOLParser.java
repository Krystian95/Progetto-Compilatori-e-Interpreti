...
public class FOOLParser extends Parser {
	...
	private static final String[] _LITERAL_NAMES = {
		...
		"'int'", "'bool'", "'class'", "'extends'", "'.'", "'void'", "'null'", 
		"'new'", "'print'"
	};
	private static final String[] _SYMBOLIC_NAMES = {
		null, "SEMIC", "COLON", "COMMA", "GE", "LE", "NOT", "AND", "OR", "EQ", 
		"ASM", "PLUS", "MINUS", "TIMES", "DIV", "TRUE", "FALSE", "LPAR", "RPAR", 
		"CLPAR", "CRPAR", "IF", "THEN", "ELSE", "LET", "IN", "VAR", "FUN", "INT", 
		"BOOL", "CLASS", "EXTENDS", "DOT", "VOID", "NULL", "NEW", "STDLIB", "INTEGER", 
	...
	public static class StartContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FOOLVisitor ) return ((FOOLVisitor<? extends T>)visitor).visitStart(this);
	...
	public final ClassdecContext classdec() throws RecognitionException {
		...
		try {
			...
			if (_la==EXTENDS) {
				...
				match(EXTENDS);
				setState(51);
				((ClassdecContext)_localctx).classextended = match(ID);
				}
			}
	...
	public static class LetfunContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FOOLVisitor ) return ((FOOLVisitor<? extends T>)visitor).visitLetfun(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FunbodyContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FOOLVisitor ) return ((FOOLVisitor<? extends T>)visitor).visitFunbody(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ExpContext exp() throws RecognitionException {
		...
		try {
			...
			{
			setState(154);
			((ExpContext)_localctx).left = factor();
			setState(157);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==AND || _la==OR) {
	...
	public final FactorContext factor() throws RecognitionException {
		...
		try {
			...
			{
			setState(159);
			((FactorContext)_localctx).left = arithmetic();
			setState(162);
			_errHandler.sync(this);
			_la = _input.LA(1);
	...
	public static class ArithmeticContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FOOLVisitor ) return ((FOOLVisitor<? extends T>)visitor).visitArithmetic(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ArithmeticContext arithmetic() throws RecognitionException {
		...
		try {
			...
			{
			setState(164);
			((ArithmeticContext)_localctx).left = term();
			setState(167);
			_errHandler.sync(this);
			_la = _input.LA(1);
	...
	public final TermContext term() throws RecognitionException {
		...
		try {
			...
			{
			setState(169);
			((TermContext)_localctx).left = denied();
			setState(172);
			_errHandler.sync(this);
			_la = _input.LA(1);
	...
	public static class DeniedContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FOOLVisitor ) return ((FOOLVisitor<? extends T>)visitor).visitDenied(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final DeniedContext denied() throws RecognitionException {
		...
		try {
			...
			if (_la==NOT) {
				{
				setState(174);
				((DeniedContext)_localctx).operator = match(NOT);
				}
			}

			setState(177);
			((DeniedContext)_localctx).right = value();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class MethodcallExpContext extends ValueContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FOOLVisitor ) return ((FOOLVisitor<? extends T>)visitor).visitMethodcallExp(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AssignmentStmContext extends StmContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FOOLVisitor ) return ((FOOLVisitor<? extends T>)visitor).visitAssignmentStm(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MethodcallStmContext extends StmContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FOOLVisitor ) return ((FOOLVisitor<? extends T>)visitor).visitMethodcallStm(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\3\2\17\20\3\2\21\22\2\u0149\2-\3\2\2\2\4\62\3\2\2\2\6[\3\2\2\2\b]\3\2"+
		"\2\2\ng\3\2\2\2\fq\3\2\2\2\16t\3\2\2\2\20z\3\2\2\2\22\u008e\3\2\2\2\24"+
		"\u0098\3\2\2\2\26\u009a\3\2\2\2\30\u009c\3\2\2\2\32\u00a1\3\2\2\2\34\u00a6"+
		"\3\2\2\2\36\u00ab\3\2\2\2 \u00b1\3\2\2\2\"\u00f9\3\2\2\2$\u00fb\3\2\2"+
		"\2&\u012d\3\2\2\2()\5\4\3\2)*\7\3\2\2*,\3\2\2\2+(\3\2\2\2,/\3\2\2\2-+"+
		"\3\2\2\2-.\3\2\2\2.\60\3\2\2\2/-\3\2\2\2\60\61\5\6\4\2\61\3\3\2\2\2\62"+
		"\63\7 \2\2\63\66\7(\2\2\64\65\7!\2\2\65\67\7(\2\2\66\64\3\2\2\2\66\67"+
		"\3\2\2\2\678\3\2\2\28A\7\23\2\29>\5\f\7\2:;\7\5\2\2;=\5\f\7\2<:\3\2\2"+
		"\2=@\3\2\2\2><\3\2\2\2>?\3\2\2\2?B\3\2\2\2@>\3\2\2\2A9\3\2\2\2AB\3\2\2"+
		"\2BC\3\2\2\2CD\7\24\2\2DH\7\25\2\2EF\5\20\t\2FG\7\3\2\2GI\3\2\2\2HE\3"+
		"\2\2\2IJ\3\2\2\2JH\3\2\2\2JK\3\2\2\2KL\3\2\2\2LM\7\26\2\2M\5\3\2\2\2N"+
		"Q\5\30\r\2OQ\5$\23\2PN\3\2\2\2PO\3\2\2\2QR\3\2\2\2RS\7\3\2\2S\\\3\2\2"+
		"\2TW\5\b\5\2UX\5\30\r\2VX\5$\23\2WU\3\2\2\2WV\3\2\2\2XY\3\2\2\2YZ\7\3"+
		"\2\2Z\\\3\2\2\2[P\3\2\2\2[T\3\2\2\2\\\7\3\2\2\2]a\7\32\2\2^_\5\24\13\2"+
		"_`\7\3\2\2`b\3\2\2\2a^\3\2\2\2bc\3\2\2\2ca\3\2\2\2cd\3\2\2\2de\3\2\2\2"+
		"ef\7\33\2\2f\t\3\2\2\2gk\7\32\2\2hi\5\16\b\2ij\7\3\2\2jl\3\2\2\2kh\3\2"+
		"\2\2lm\3\2\2\2mk\3\2\2\2mn\3\2\2\2no\3\2\2\2op\7\33\2\2p\13\3\2\2\2qr"+
		"\5\26\f\2rs\7(\2\2s\r\3\2\2\2tu\5\f\7\2uv\7\f\2\2vw\5\30\r\2w\17\3\2\2"+
		"\2x{\5\26\f\2y{\7#\2\2zx\3\2\2\2zy\3\2\2\2{|\3\2\2\2|}\7(\2\2}\u0086\7"+
		"\23\2\2~\u0083\5\f\7\2\177\u0080\7\5\2\2\u0080\u0082\5\f\7\2\u0081\177"+
