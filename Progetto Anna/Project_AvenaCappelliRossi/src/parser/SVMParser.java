...
public class SVMParser extends Parser {
	...
	public final PushContext push() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				match(PUSH);
				setState(116);
				((PushContext)_localctx).n = match(NUMBER);
				}
				break;
			case 2:
				...
				match(PUSH);
				setState(118);
				((PushContext)_localctx).l = match(LABEL);
				}
				break;
			}
		}
	...
	public static class AllocContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitAlloc(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final AllocContext alloc() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				match(ALLOC);
				setState(124);
				((AllocContext)_localctx).n = match(NUMBER);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				match(ALLOC);
				setState(126);
				((AllocContext)_localctx).l = match(LABEL);
				}
				break;
			}
		}
	...
	public static class RemoveContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitRemove(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LoadFieldContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLoadField(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StoreFieldContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitStoreField(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class JumpDispatchTableContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitJumpDispatchTable(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LoadReturnAddressContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLoadReturnAddress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StoreReturnAddressContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitStoreReturnAddress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LoadReturnValueContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLoadReturnValue(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StoreReturnValueContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitStoreReturnValue(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LoadFramePointerContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLoadFramePointer(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StoreFramePointerContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitStoreFramePointer(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CopyFramePointerContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitCopyFramePointer(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LoadHeapPointerContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLoadHeapPointer(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StoreHeapPointerContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitStoreHeapPointer(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LoadDispatchPointerContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLoadDispatchPointer(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StoreDispatchPointerContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitStoreDispatchPointer(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LoadInfoObjectContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLoadInfoObject(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StoreInfoObjectContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitStoreInfoObject(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LoadObjectPointerContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLoadObjectPointer(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StoreObjectPointerContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitStoreObjectPointer(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\36 \"$&(*,.\60\62\64\668:<>@BDFHJ\2\2\2\u00cb\2r\3\2\2\2\4y\3\2\2\2\6"+
