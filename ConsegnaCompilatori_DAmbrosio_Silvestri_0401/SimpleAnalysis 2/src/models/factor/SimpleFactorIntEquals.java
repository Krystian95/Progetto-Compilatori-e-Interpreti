...
public class SimpleFactorIntEquals extends SimpleFactor {

	SimpleValue left;
	SimpleValue right;

	public SimpleFactorIntEquals(SimpleValue left, SimpleValue right) {
		this.left = left;
		this.right = right;
	}
	...
	@Override
	public String toPrint(String boolEqu) {
		return boolEqu+"Equal\n" + left.toPrint(boolEqu+"  ")   
		+ right.toPrint(boolEqu+"  ") ; 
	}
